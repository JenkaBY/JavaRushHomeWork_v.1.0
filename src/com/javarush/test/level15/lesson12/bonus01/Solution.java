...
public class Solution {
    ...
    public static void reset() {
        //add your code here - добавьте код тут
        BufferedReader type = null;
        try
        {
           type = new BufferedReader(new InputStreamReader(System.in)) ;
            switch (type.readLine()){
                case "plane":
                    int quantityPass = Integer.parseInt(type.readLine());
                    result = new Plane(quantityPass);
                    break;
                case "helicopter":
