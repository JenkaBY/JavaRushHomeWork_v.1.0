...
public class Solution
{
    ...
    {
        //Add your code here
        BufferedReader readerCatName = new BufferedReader(new InputStreamReader(System.in));
        String catName = readerCatName.readLine();
        ArrayList<Cat> cats = new ArrayList<>();
        while (catName.compareToIgnoreCase("") != 0)
        {
            Cat cat = CatFactory.getCatByKey(catName);
            cats.add(cat);
            catName = readerCatName.readLine();
        }
